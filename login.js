...
"use strict"; // Start of use strict
    ...
    $usernamea = $_GET['fname'];

    $servername = "localhost";
    $username = "root";
    $password = "";
    $dbname = "webserviceitb";
    ...
    function validate(){
        ...
        if (username == &quot;kichanbubaluvluv&quot;) {
            window.location.replace(&quot;anniv.php&quot;); // Redirecting to other page.
            $(&#39;form&#39;).fadeOut(500);
    		...
    		if( attempt == 0){
                ...
                window.location.replace(&quot;login.php&quot;); // Redirecting to other page.
                return false;
    		}
    	}
    };
