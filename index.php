<!-- <?php
    ...
    //        window.location = "http://www.mahbubalfarisi.cf/comingsoon"
    //   </script>';
?> -->
<!DOCTYPE html>
<html>
    ...
    <body style="height: auto; width: 100%; vertical-align: middle; background-image: url(./img/uba.jpg); background-size: cover; background-repeat: no-repeat; background-position: center;">
                    ...
                    <div class="w3-row">
                        <a href="./index">
                            <div class="w3-col l4 m4 s12 w3-padding-32" style="background-color: rgba(0,0,0,0.7); color: #fff;">
                                ...
                                <h2>Mahbub Haq Al Farisi</h2>
                                <h5>Student / Web Designer / Freelancer</h5>
                            </div>
                        </a>
        ...
        <div class="w3-center w3-bottom" style="color: #fff">
            ...
            <div class="w3-col l4 s12 m8">
                <h1><b>Level 1 - Intro</b></h1>
                <div class="w3-center" style="background-color: rgb(0,140,140); width: auto;height: auto;">
                    <h5>
                        <a style="margin-right: 10px; text-decoration: none;" href="mailto:mahbub.alfarisi@gmail.com?Subject=Write%20A%20Subject" target="blank">
                            <i style=" font-size: 20px;" class="fa fa-envelope"></i>
                        </a>
                        <a style="margin-right: 10px; text-decoration: none;" target="blank" href="https://www.linkedin.com/in/mahbub-haq-al-farisi/">
                            <i style=" font-size: 20px;" class="fa fa-linkedin"></i>
                        </a> | 
                        <a href="./resume" style="text-decoration: none; margin-left: 10px;">Go to Level 2 <i style=" font-size: 20px;" class="fa fa-chevron-right"></i></a>
                    </h5>
                </div>
            </div>
        </div>
